...
function calculate_turbulent_line_profile(bins, m, x, d, correlation_length, a, M, L, L_edd, r_ms, epsilon)
...
for inc_angle in inc_angles
    ...
    flux_turbulent = calculate_turbulent_line_profile(bins, m, x, d, correlation_length, a, M, L, L_edd, r_ms, epsilon, mach)
